...
def main():
    ...
    with zipfile.ZipFile(sys.argv[1]) as package:
        ...
        assert manifest['Name'] == 'Hellpod Steering Unlocked - v7.2'
        assert manifest['Options'] == [{'Name': 'Hellpod Steering Unlocked - v7.2', 'Description': manifest['Description'],
        ...
        assert provenance['revision'] == 'data-v7.2' and provenance['runtime_verified'] is False
